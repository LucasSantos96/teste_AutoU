...
export const EmailResultPage: React.FC = () => {
  return (
    <PageContainer>
              ...
              <div className="px-5 pt-1 pb-4">
                <div className="rounded-2xl bg-slate-900/80 border border-slate-700/80 px-4 py-3">
                  <p className="text-sm leading-relaxed text-slate-100/90">
                    {`"Olá, agradecemos o seu contato. No momento, não conseguimos dar prosseguimento a esta solicitação. Atenciosamente, Equipe de Suporte."`}
                  </p>
                </div>

                <div className="mt-4 flex items-center gap-2">
                  <PrimaryButton label="Copiar Resposta" className="flex-1 justify-center" />
                  <button
                    type="button"
